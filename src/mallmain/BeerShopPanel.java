...
import beershop.Beer;
import beershop.BeerList;
import beershop.BeerSearchResult;
...
class BeerShopPanel extends JPanel {
    ...
    private void showAllBeer() {
        ...
        for (Beer beer : BeerList.getBeerList()) {
            ...
            BeerSearchResult card = new BeerSearchResult(beer);
